...
You can specify a character range inside the brackets.
**Example** 
...
Allows you to specify a list of alternatives.
**Example:** 

file{1,2,3}.txt will match file1.txt, file2.txt, and file3.txt.


6. **Double asterisk** (in some contexts, like in bash)
   
Matches directories or files at any depth (used in recursive patterns).
**Example:** 
